...
namespace Exlibris
{
    ...
    {
        private readonly ConcurrentDictionary<Type, object> cacheOfCashes = new ConcurrentDictionary<Type, object>();
        ...
        public bool TryGetValue<T>(ExcelAddress address, out T value)
        {
            var cache = GetCache<T>();
