    ...
    public static object PUT(
        ...
        => ExlibrisAddin.GetFunctionSupport().ErrorValueIfThrown(support =>
        {
            ...
            return support.Observe((observer, disposer, cancellationToken) => Task.Run(async () =>
            {
                ...
                var request = CreateRequest(HttpMethod.Put, requestUri, paramVal, CreateHttpContentFromScalar(support, dataVal, contentTypeVal), support);
