...
public static class WebAPIUtil
{
    ...
    public static HttpClient NewClinet(HttpClientSetting setting)
    {
        ...
        if (setting.Version != null) { client.DefaultRequestVersion = Version.Parse(setting.Version); }
        if (setting.VersionPolicy != null) { client.DefaultVersionPolicy = setting.VersionPolicy.Value; }
    ...
    public static void UpdateRequest(HttpRequestMessage request, HttpRequestSetting? setting)
    {
        ...
        if (setting.VersionPolicy != null) { request.VersionPolicy = setting.VersionPolicy.Value; }
    }
